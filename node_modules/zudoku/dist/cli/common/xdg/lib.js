...
export const ZUDOKU_XDG_CONFIG_HOME = path.join(XDG_CONFIG_HOME, CLI_XDG_FOLDER_NAME);
export const ZUDOKU_XDG_DATA_HOME = path.join(XDG_DATA_HOME, CLI_XDG_FOLDER_NAME);
export const ZUDOKU_XDG_STATE_HOME = path.join(XDG_STATE_HOME, CLI_XDG_FOLDER_NAME);
