...
describe("removePaths", () => {
    ...
    it("removes both paths and methods based on shouldRemove callback", () => {
        const processed = removePaths({
            shouldRemove: ({ path, method }) => path.startsWith("/remove") || method === "post",
        })({
            schema: baseDoc,
            file: "/file.json",
            dereference: async (id) => id,
    ...
    it("removes entire paths via shouldRemove callback", () => {
        const processed = removePaths({
            shouldRemove: ({ path, method }) => method === true && path === "/remove-me",
        })({
            schema: baseDoc,
            file: "/file.json",
            dereference: async (id) => id,
...
//# sourceMappingURL=removePaths.test.js.map