...
export const Markdown = memo(({ content, className }) => (_jsx(ReactMarkdown, { remarkPlugins: remarkPlugins, rehypePlugins: rehypePlugins, components: MdxComponents, className: className, children: content })));
