...
describe("joinUrl", () => {
    ...
    test("handles falsy values", () => {
        expect(joinUrl("https://example.com", null, undefined, false, "path")).toBe("https://example.com/path");
    });
    test("handles numeric values", () => {
        expect(joinUrl("https://example.com", "api", 123, "test")).toBe("https://example.com/api/123/test");
    });
...
//# sourceMappingURL=joinUrl.test.js.map