// node_modules/zudoku/lib/circular-ByJI6Mci.js
function ye(e, n) {
  if (!!!e)
    throw new Error(n);
}
...
function ei(e, n) {
  ...
  for (const t of e.body.matchAll(vu)) {
    if (typeof t.index == "number" || yu(false), t.index >= n)
      break;
...
function Su(e, n, a) {
  ...
  if (r === 46 && (s = true, r = i.charCodeAt(++t), t = xr(e, t, r), r = i.charCodeAt(t)), (r === 69 || r === 101) && (s = true, r = i.charCodeAt(++t), (r === 43 || r === 45) && (r = i.charCodeAt(++t)), t = xr(e, t, r), r = i.charCodeAt(t)), r === 46 || ai(r))
    throw Ue(
      e.source,
      t,
...
var Mu = globalThis.process && // eslint-disable-next-line no-undef
false;
var He = (
  /* c8 ignore next 6 */
...
var $u = class {
  constructor(n, a = "GraphQL request", i = {
    ...
    typeof n == "string" || ye(false, `Body must be a string. Received: ${ke(n)}.`), this.body = n, this.name = a, this.locationOffset = i, this.locationOffset.line > 0 || ye(
      false,
...
var zu = /[\x00-\x1f\x22\x5c\x7f-\x9f]/g;
function Xu(e) {
...
function Wu(e, n, a = io) {
  ...
  do {
    ...
    if (!Array.isArray(d)) {
      var l, f;
      Ri(d) || ye(false, `Invalid AST Node: ${ke(d)}.`);
...
function xe(e) {
  if (e != null || ye(false, "Must provide name."), typeof e == "string" || ye(false, "Expected name to be a string."), e.length === 0)
...
var ic = class {
  constructor(n) {
    po(n) || ye(false, `Expected ${ke(n)} to be a GraphQL type.`), this.ofType = n;
  }
  get [Symbol.toStringTag]() {
    return "GraphQLList";
  }
...
var mc = class {
  constructor(n) {
    var a, i;
    this.name = xe(n.name), this.description = n.description, this.extensions = Ke(n.extensions), this.astNode = n.astNode, this.extensionASTNodes = (a = n.extensionASTNodes) !== null && a !== void 0 ? a : [], this.isOneOf = (i = n.isOneOf) !== null && i !== void 0 ? i : false, this._fields = hc.bind(void 0, n);
  }
  get [Symbol.toStringTag]() {
...
function pi() {
  ...
  function a(i, t) {
    ...
    for (const u of i.body.matchAll(n)) {
      if (typeof u.index == "number" || (0, e.invariant)(false), u.index >= t)
        break;
...
function Pr() {
  ...
  function i(r) {
    if (r === "")
      return true;
    let s = true, u = false, c = true, d = false;
...
function yi() {
  ...
  function f(N, g, L) {
    ...
    if (b === 46 && (I = true, b = E.charCodeAt(++v), v = h(N, v, b), b = E.charCodeAt(v)), (b === 69 || b === 101) && (I = true, b = E.charCodeAt(++v), (b === 43 || b === 45) && (b = E.charCodeAt(++v)), v = h(N, v, b), b = E.charCodeAt(v)), b === 46 || (0, i.isNameStart)(b))
      throw (0, e.syntaxError)(
        N.source,
        v,
...
function Wn() {
  ...
  var e = di(), n = Ze(), a = Hn(), i = oe(), t = yi(), r = vi(), s = Fr();
  function u(l, f) {
  ...
  function c(l, f) {
    ...
    const T = h.parseValueLiteral(false);
  ...
  class o {
    ...
    parseFragmentDefinition() {
      const f = this._lexer.token;
      return this.expectKeyword("fragment"), this._options.allowLegacyFragmentVariables === true ? this.node(f, {
     ...
     */
    node(f, h) {
      return this._options.noLocation !== true && (h.loc = new n.Location(
        f,
    ...
    expectOptionalToken(f) {
      return this._lexer.token.kind === f ? (this.advanceLexer(), true) : false;
    }
    /**
    ...
    expectOptionalKeyword(f) {
      const h = this._lexer.token;
      return h.kind === s.TokenKind.NAME && h.value === f ? (this.advanceLexer(), true) : false;
    }
    /**
...
function Cr() {
  ...
  var e = Ae(), n = ne(), a = hi();
  function i(r) {
    if (r != null || (0, e.devAssert)(false, "Must provide name."), typeof r == "string" || (0, e.devAssert)(false, "Expected name to be a string."), r.length === 0)
...
function ue() {
  ...
  var e = Ae(), n = cn(), a = bc(), i = fe(), t = wr(), r = We(), s = ln(), u = kr(), c = No(), d = pn(), m = Ti(), o = ne(), p = oe(), y = Ge(), l = Oo(), f = Cr();
  function h(A) {
  ...
  class _i {
    constructor(F) {
      var Q, se;
      this.name = (0, f.assertName)(F.name), this.description = F.description, this.extensions = (0, m.toObjMap)(F.extensions), this.astNode = F.astNode, this.extensionASTNodes = (Q = F.extensionASTNodes) !== null && Q !== void 0 ? Q : [], this.isOneOf = (se = F.isOneOf) !== null && se !== void 0 ? se : false, this._fields = du.bind(void 0, F);
    }
    get [Symbol.toStringTag]() {
      return "GraphQLInputObjectType";
    }
...
function Gr() {
  ...
  var e = ue();
  function n(t, r) {
    return t === r ? true : (0, e.isNonNullType)(t) && (0, e.isNonNullType)(r) || (0, e.isListType)(t) && (0, e.isListType)(r) ? n(t.ofType, r.ofType) : false;
  }
  function a(t, r, s) {
    return r === s ? true : (0, e.isNonNullType)(s) ? (0, e.isNonNullType)(r) ? a(t, r.ofType, s.ofType) : false : (0, e.isNonNullType)(r) ? a(t, r.ofType, s) : (0, e.isListType)(s) ? (0, e.isListType)(r) ? a(t, r.ofType, s.ofType) : false : (0, e.isListType)(r) ? false : (0, e.isAbstractType)(s) && ((0, e.isInterfaceType)(r) || (0, e.isObjectType)(r)) && t.isSubType(s, r);
  }
  function i(t, r, s) {
    return r === s ? true : (0, e.isAbstractType)(r) ? (0, e.isAbstractType)(s) ? t.getPossibleTypes(r).some((u) => t.isSubType(s, u)) : t.isSubType(r, s) : (0, e.isAbstractType)(s) ? t.isSubType(s, r) : false;
  }
  return gn;
}
var ge = {};
...
function en() {
  ...
  var e = fe(), n = We(), a = ne(), i = oe(), t = Ge(), r = ue();
  const s = 2147483647;
...
function Ve() {
  ...
  var e = Ae(), n = fe(), a = wr(), i = We(), t = Ti(), r = Hn(), s = Cr(), u = ue(), c = en();
  function d(D) {
  ...
  class o {
    constructor(_) {
      var w, M;
      this.name = (0, s.assertName)(_.name), this.description = _.description, this.locations = _.locations, this.isRepeatable = (w = _.isRepeatable) !== null && w !== void 0 ? w : false, this.extensions = (0, t.toObjMap)(_.extensions), this.astNode = _.astNode, Array.isArray(_.locations) || (0, e.devAssert)(
        false,
...
function Mr() {
  ...
  var e = fe(), n = Re(), a = bi(), i = We(), t = oe(), r = ue(), s = en();
  function u(d, m) {
...
function Qe() {
  ...
  var e = fe(), n = Re(), a = Hn(), i = Ge(), t = Mr(), r = ue(), s = en();
...
function Rn() {
  ...
  var e = Ae(), n = fe(), a = wr(), i = We(), t = Ti(), r = Ze(), s = ue(), u = Ve(), c = Qe();
  function d(y) {
  ...
  class o {
    ...
    constructor(l) {
      var f, h;
      this.__validationErrors = l.assumeValid === true ? [] : void 0, (0, i.isObjectLike)(l) || (0, e.devAssert)(false, "Must provide configuration object."), !l.types || Array.isArray(l.types) || (0, e.devAssert)(
        false,
...
function $r() {
  ...
  var e = fe(), n = ne(), a = Ze(), i = Gr(), t = ue(), r = Ve(), s = Qe(), u = Rn();
  function c(E) {
...
`));
  ...
  function D(E, v) {
    ...
    for (const S of b) {
      ...
      I[S.name] = true, (0, t.isObjectType)(S) || E.reportError(
  ...
  function V(E) {
    ...
    function S(j) {
      if (v[j.name])
        return;
      v[j.name] = true, I[j.name] = b.length;
...
function gi() {
  ...
  var e = Ze(), n = oe(), a = Ln(), i = ue(), t = Qe(), r = nn();
  let s = class {
    constructor(m, o, p) {
...
function Ro() {
  ...
  var e = fe(), n = Re(), a = ne(), i = Ze(), t = Hn(), r = oe(), s = Ve();
  function u(m) {
  ...
  function c(m) {
    ...
    switch ("kind" in o || (0, n.invariant)(false), o.kind) {
      ...
      case r.Kind.INPUT_VALUE_DEFINITION: {
        ...
        return "kind" in p || (0, n.invariant)(false), p.kind === r.Kind.INPUT_OBJECT_TYPE_DEFINITION ? t.DirectiveLocation.INPUT_FIELD_DEFINITION : t.DirectiveLocation.ARGUMENT_DEFINITION;
      }
...
function Ao() {
  ...
  var e = cn(), n = pn(), a = ne(), i = Dn(), t = Qe(), r = en();
  function s(d) {
    ...
    for (const l of d.getDocument().definitions)
      (0, i.isTypeDefinitionNode)(l) && (p[l.name.value] = true);
    const y = [
      ...Object.keys(o),
      ...Object.keys(p)
    ];
...
function Vo() {
  ...
  function n(a) {
    ...
    return {
      OperationDefinition(r) {
        return i.push(r), false;
      },
      FragmentDefinition(r) {
        return t.push(r), false;
      },
      Document: {
        leave() {
...
function Mo() {
  ...
  var e = fe(), n = ne(), a = oe(), i = Ge(), t = ue(), r = Go(), s = nn();
  function u(N) {
  ...
  function O(N, g) {
    return (0, t.isListType)(N) ? (0, t.isListType)(g) ? O(N.ofType, g.ofType) : true : (0, t.isListType)(g) ? true : (0, t.isNonNullType)(N) ? (0, t.isNonNullType)(g) ? O(N.ofType, g.ofType) : true : (0, t.isNonNullType)(g) ? true : (0, t.isLeafType)(N) || (0, t.isLeafType)(g) ? N !== g : false;
  }
  function R(N, g, L, E) {
    const v = g.get(E);
    if (v)
  ...
  class M {
    ...
    has(g, L, E) {
      ...
      return b === void 0 ? false : E ? true : E === b;
    }
    add(g, L, E) {
...
function Uo() {
  ...
  var e = cn(), n = fe(), a = Re(), i = pn(), t = ne(), r = oe(), s = Dn(), u = ue();
  function c(p) {
...
function Qo() {
  ...
  var e = fe(), n = ln(), a = ne(), i = oe(), t = Ge(), r = ue(), s = Ve();
  function u(m) {
    return {
      // eslint-disable-next-line new-cap
      ...c(m),
...
function xo() {
  ...
  var e = cn(), n = fe(), a = Re(), i = bi(), t = We(), r = Ur(), s = Ko(), u = pn(), c = ne(), d = ue();
  function m(y, l, f = o) {
...
function Zn() {
  ...
  var e = fe(), n = ln(), a = Ko(), i = ne(), t = oe(), r = Ge(), s = ue(), u = xo(), c = nn(), d = Qr();
  function m(f, h, T, O) {
...
function Ei() {
  ...
  function c(o, p) {
    ...
    return (l == null ? void 0 : l.if) !== false;
  }
  function d(o, p, y) {
    ...
    return f === y ? true : (0, n.isAbstractType)(f) ? o.isSubType(f, y) : false;
  }
  function m(o) {
...
function Wo() {
  ...
  function i(t, r) {
    return (0, n.isObjectType)(t) || (0, n.isInterfaceType)(t) || (0, n.isInputObjectType)(t) ? t.getFields()[r] != null : false;
  }
  return er;
}
var nr = {};
...
function au() {
  ...
  var e = cn(), n = fe(), a = ln(), i = pn(), t = ne(), r = oe(), s = Ge(), u = ue();
  function c(o) {
    let p = {};
    return {
      OperationDefinition: {
...
function ou() {
  ...
  var e = fe(), n = ne(), a = oe(), i = ue(), t = Gr(), r = nn();
  function s(c) {
...
function uu() {
  ...
  var e = _o(), n = Io(), a = So(), i = Lo(), t = Ro(), r = Do(), s = Ao(), u = jo(), c = Po(), d = Fo(), m = wo(), o = ko(), p = Vo(), y = Co(), l = Mo(), f = $o(), h = Uo(), T = Qo(), O = qo(), R = Bo(), D = Yo(), _ = Jo(), w = zo(), M = Xo(), V = Ho(), N = Wo(), g = Zo(), L = eu(), E = nu(), v = tu(), b = ru(), I = iu(), S = au(), j = su(), k = ou();
...
function Kr() {
  ...
  var e = Ae(), n = fe(), a = Re(), i = bi(), t = We(), r = mi(), s = Ec(), u = Ur(), c = Nc(), d = Oc(), m = ne(), o = fi(), p = Ze(), y = oe(), l = ue(), f = Qe(), h = $r(), T = Ei(), O = Zn();
  ...
  function M(G, $, x) {
    $ || (0, e.devAssert)(false, "Must provide document."), (0, h.assertValidSchema)(G), x == null || (0, t.isObjectLike)(x) || (0, e.devAssert)(
      false,
  ...
  function L(G, $, x, B, ee) {
    ...
    try {
      for (const [re, ce] of ee.entries()) {
        ...
        be !== void 0 && (Y[re] = be, (0, r.isPromise)(be) && (Z = true));
      }
    } catch (re) {
      if (Z)
    ...
    const ce = Array.from(Y, (de, be) => {
      ...
      try {
        ...
        return (0, r.isPromise)(de) ? ve = de.then(
          ...
          Ie,
          de
        ), (0, r.isPromise)(ve) ? (re = true, ve.then(void 0, (Ee) => {
...
function _c() {
  ...
  var e = Ae(), n = mi(), a = Wn(), i = $r(), t = qr(), r = Kr();
  function s(d) {
...
function Ic() {
  return Ds || (Ds = 1, function(e) {
    ...
    var n = Rn(), a = ue(), i = Ve(), t = en(), r = Qe(), s = $r(), u = Cr();
  }(Jr)), Jr;
}
var zr = {};
var As;
function Sc() {
  return As || (As = 1, function(e) {
    ...
    var n = vi(), a = pi(), i = go(), t = oe(), r = Fr(), s = yi(), u = Wn(), c = Ge(), d = Ln(), m = Ze(), o = Dn(), p = Hn();
  }(zr)), zr;
}
var Xr = {};
var $n = {};
...
function Dc() {
  ...
  var e = Ae(), n = fe(), a = Lc(), i = Ur(), t = ne(), r = fi(), s = Ei(), u = Kr(), c = Rc(), d = Zn();
  async function m(l) {
    arguments.length < 2 || (0, e.devAssert)(
      false,
      "graphql@16 dropped long-deprecated support for positional arguments, please pass an object instead."
    ...
    return {
      Field(r) {
        ...
        if (s && u != null) {
          ...
          c != null || (0, e.invariant)(false), t.reportError(
            new n.GraphQLError(
      ...
      Argument(r) {
        ...
        if (s && u != null) {
          ...
          if (c != null)
            ...
            d != null && m != null || (0, e.invariant)(false), t.reportError(
              new n.GraphQLError(
...
function Fc() {
  return Cs || (Cs = 1, function(e) {
    ...
    var n = qr(), a = cu(), i = uu(), t = _o(), r = Io(), s = So(), u = Lo(), c = Ro(), d = Do(), m = Ao(), o = jo(), p = wo(), y = ko(), l = Vo(), f = Co(), h = Mo(), T = $o(), O = Qo(), R = qo(), D = Bo(), _ = Jo(), w = Xo(), M = Zo(), V = eu(), N = nu(), g = iu(), L = au(), E = su(), v = ou(), b = Fo(), I = Po(), S = tu(), j = ru(), k = Ho(), U = Wo(), W = Yo(), P = zo(), K = Uo(), te = jc(), pe = Pc();
  }(Hr)), Hr;
}
var Wr = {};
var vr = {};
...
function Vc() {
  ...
  function t(r, s) {
    ...
    return !d.errors && d.data || (0, e.invariant)(false), d.data;
  }
  return gr;
}
var Er = {};
...
function Cc() {
  ...
  var e = Ae(), n = fe(), a = We(), i = kr(), t = Wn(), r = ue(), s = Ve(), u = Qe(), c = en(), d = Rn(), m = Qr();
  function o(p, y) {
...
function pu() {
  ...
  var e = Ae(), n = fe(), a = Re(), i = ln(), t = No(), r = oe(), s = Dn(), u = ue(), c = Ve(), d = Qe(), m = en(), o = Rn(), p = qr(), y = Zn(), l = Qr();
  function f(_, w, M) {
    (0, o.assertSchema)(_), w != null && w.kind === r.Kind.DOCUMENT || (0, e.devAssert)(false, "Must provide valid Document AST."), (M == null ? void 0 : M.assumeValid) !== true && (M == null ? void 0 : M.assumeValidSDL) !== true && (0, p.assertValidSDLExtension)(w, _);
  ...
  function h(_, w, M) {
    ...
    return {
      ...
      assumeValid: (L = M == null ? void 0 : M.assumeValid) !== null && L !== void 0 ? L : false
    };
    function W(C) {
...
function Gc() {
  ...
  var e = Ae(), n = oe(), a = Wn(), i = Ve(), t = Rn(), r = qr(), s = pu();
  function u(d, m) {
    d != null && d.kind === n.Kind.DOCUMENT || (0, e.devAssert)(false, "Must provide valid Document AST."), (m == null ? void 0 : m.assumeValid) !== true && (m == null ? void 0 : m.assumeValidSDL) !== true && (0, r.assertValidSDL)(d);
    const o = {
      description: void 0,
      types: [],
      directives: [],
...
function Mc() {
  ...
  var e = fe(), n = Re(), a = kr(), i = Vr(), t = ue(), r = Ve(), s = Qe(), u = Rn();
  function c(p) {
...
function $c() {
  ...
  var e = fe(), n = Re(), a = Pr(), i = oe(), t = Ge(), r = ue(), s = Ve(), u = Qe(), c = en(), d = Mr();
  function m(S) {
    return y(
      S,
...
function Kc() {
  ...
  function t(r) {
    if (typeof r == "string" || (0, e.devAssert)(false, "Expected name to be a string."), r.startsWith("__"))
...
function xc() {
  ...
  var e = fe(), n = Re(), a = ln(), i = Ge(), t = ue(), r = en(), s = Mr(), u = Go(), c;
  ...
  function V(g, L) {
    ...
    return E != null || (0, n.invariant)(false), (0, i.print)((0, u.sortValueNode)(E));
  }
  function N(g, L) {
...
function Bc() {
  return Ws || (Ws = 1, function(e) {
    ...
    var n = lu(), a = wc(), i = kc(), t = Vc(), r = Cc(), s = Gc(), u = pu(), c = Mc(), d = $c(), m = nn(), o = Qr(), p = Oo(), y = Mr(), l = gi(), f = xo(), h = Uc(), T = Qc(), O = qc(), R = Gr(), D = Kc(), _ = xc();
  }(Wr)), Wr;
}
var Zs;
function Yc() {
  return Zs || (Zs = 1, function(e) {
    ...
    var n = Tc(), a = _c(), i = Ic(), t = Sc(), r = Ac(), s = Fc(), u = vc(), c = Bc();
  }(Yr)), Yr;
}
var Jc = Yc();
var Zr = "$[Circular Reference]";
var ii = (e, n = /* @__PURE__ */ new Map(), a = []) => {
  if (e === Zr) return Zr;
...
var pl = new Jc.GraphQLScalarType({
  ...Ci,
  name: "JSONSchema",
...
//# sourceMappingURL=chunk-2R5R3JQD.js.map
