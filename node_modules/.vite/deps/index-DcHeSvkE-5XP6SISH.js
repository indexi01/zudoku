...
// node_modules/zudoku/lib/index-DcHeSvkE.js
...
var j = Symbol.for("yaml.node.type");
var x = (s) => !!s && typeof s == "object" && s[j] === dt;
var ee = (s) => !!s && typeof s == "object" && s[j] === lt;
var de = (s) => !!s && typeof s == "object" && s[j] === G;
var T = (s) => !!s && typeof s == "object" && s[j] === qt;
var E = (s) => !!s && typeof s == "object" && s[j] === R;
var pe = (s) => !!s && typeof s == "object" && s[j] === he;
function L(s) {
...
var Qt = (s) => !s || typeof s != "function" && typeof s != "object";
var A = class extends pt {
  constructor(e) {
...
` && w !== "	" && (d = u);
      ...
      if (u >= f)
        if (d)
          ...
          if (p[w])
            return s;
          c.push(w), p[w] = true, f = w + a, d = void 0;
        } else
          y = true;
    }
    h = N;
...
${t}`) + "'";
  return e.implicitKey ? n : Ue(n, t, Ht, Ve(e, false));
}
function le(s, e) {
...
function Me({ comment: s, type: e, value: t }, n, i, r) {
  ...
  if (!o || /\n[\t ]+$/.test(t) || /^\s*$/.test(t))
    return le(t, n);
  const c = n.indent || (n.forceBlockIndent || Je(t) ? "  " : ""), p = o === "literal" ? true : o === "folded" || e === A.BLOCK_FOLDED ? false : e === A.BLOCK_LITERAL ? true : !qs(t, a, c.length);
  if (!t)
    return p ? `|
` : `>
`;
...
${a}`);
  ...
  return l ? f : Ue(f, a, Ht, Ve(e, false));
}
function Ae(s, e, t, n) {
...
function Vs({ key: s, value: e }, t, n, i) {
  ...
  let y = false, u = false, m = fe(s, t, () => y = true, () => u = true);
...
${l}:`) : (m = `${m}:`, d && (m += H(m, t.indent, c(d))));
  let b, S, N;
  $(e) ? (b = !!e.spaceBefore, S = e.commentBefore, N = e.comment) : (b = false, S = null, N = null, e && typeof e == "object" && (e = o.createNode(e))), t.implicitKey = false, !h && !d && E(e) && (t.indentAtStart = m.length + 1), u = false, !p && a.length >= 2 && !t.inFlow && !h && pe(e) && !e.flow && !e.tag && !e.anchor && (t.indent = t.indent.substring(2));
  let w = false;
  const k = fe(e, t, () => w = true, () => u = true);
  let O = " ";
  if (d || b || S) {
    if (O = b ? `
` : "", S) {
...
`), _ = g !== -1, J = t.inFlow ?? e.flow ?? e.items.length === 0;
    if (_ || !J) {
      ...
      if (_ && (I === "&" || I === "!")) {
        let C = k.indexOf(" ");
        I === "&" && C !== -1 && C < g && k[C + 1] === "!" && (C = k.indexOf(" ", C + 1)), (C === -1 || g < C) && (te = true);
      }
      te || (O = `
${t.indent}`);
    }
...
var Js = (s, e) => (V.identify(e) || E(e) && (!e.type || e.type === A.PLAIN) && V.identify(e.value)) && (s == null ? void 0 : s.doc.schema.tags.some((t) => t.tag === V.tag && t.default));
function Zt(s, e, t) {
...
function Ys(s, e, t) {
  ...
  if ($(s) && (t != null && t.doc)) {
    ...
    if (!t.mapKeyWarned) {
      ...
      r.length > 40 && (r = r.substring(0, 36) + '..."'), zt(t.doc.options.logLevel, `Keys with collection values will be stringified due to JS Object restrictions: ${r}. Set mapAsMap: true to use object keys.`), t.mapKeyWarned = true;
    }
    return i;
  }
...
function Gs({ comment: s, items: e }, t, { blockItemPrefix: n, flowChars: i, itemIndent: r, onChompKeep: o, onComment: l }) {
  ...
  for (let y = 0; y < e.length; ++y) {
    ...
    f = false;
    let b = fe(u, p, () => m = null, () => f = true);
    m && (b += H(b, r, c(m))), f && m && (f = false), d.push(n + b);
  }
  let h;
  if (d.length === 0)
    h = i.start + i.end;
...
function Qs({ items: s }, e, { flowChars: t, itemIndent: n }) {
  ...
  for (let y = 0; y < s.length; ++y) {
    ...
    let m = null;
    if ($(u))
      u.spaceBefore && f.push(""), je(e, f, u.commentBefore, false), u.comment && (m = u.comment);
    else if (T(u)) {
      const S = $(u.key) ? u.key : null;
      S && (S.spaceBefore && f.push(""), je(e, f, S.commentBefore, false), S.comment && (c = true));
      const N = $(u.value) ? u.value : null;
      N ? (N.comment && (m = N.comment), N.commentBefore && (c = true)) : u.value == null && (S != null && S.comment) && (m = S.comment);
    }
    m && (c = true);
    let b = fe(u, a, () => m = null);
    y < s.length - 1 && (b += ","), m && (b += H(b, n, l(m))), !c && (f.length > p || b.includes(`
`)) && (c = true), f.push(b), p = f.length;
  }
...
var K = class extends Wt {
  ...
  toString(e, t, n) {
    ...
    return !e.allNullValues && this.hasAllNullValues(false) && (e = Object.assign({}, e, { allNullValues: true })), es(this, e, {
      blockItemPrefix: "",
      flowChars: { start: "{", end: "}" },
      itemIndent: e.indent || "",
      onChompKeep: n,
...
function an(s, e) {
  ...
  if (e.directives !== false && s.directives) {
    ...
    c ? (t.push(c), n = true) : s.directives.docStart && (n = true);
  }
  n && t.push("---");
...
function ue(s, { flow: e, indicator: t, next: n, offset: i, onError: r, parentIndent: o, startOnNewline: l }) {
  let a = false, c = l, p = l, f = "", d = "", h = false, y = false, u = null, m = null, b = null, S = null, N = null, w = null, k = null;
  for (const g of s)
    switch (y && (g.type !== "space" && g.type !== "newline" && g.type !== "comma" && r(g.offset, "MISSING_CHAR", "Tags and anchors must be separated from the next token by white space"), y = false), u && (c && g.type !== "comment" && g.type !== "newline" && r(u, "TAB_AS_INDENT", "Tabs are not allowed as indentation"), u = null), g.type) {
      case "space":
        !e && (t !== "doc-start" || (n == null ? void 0 : n.type) !== "flow-collection") && g.source.includes("	") && (u = g), p = true;
        break;
      case "comment": {
        p || r(g, "MISSING_CHAR", "Comments must be separated from other tokens by white space characters");
        const _ = g.source.substring(1) || " ";
        f ? f += d + _ : f = _, d = "", c = false;
        break;
      }
      case "newline":
        c ? f ? f += g.source : (!w || t !== "seq-item-ind") && (a = true) : d += g.source, c = true, h = true, (m || b) && (S = g), p = true;
        break;
      case "anchor":
        m && r(g, "MULTIPLE_ANCHORS", "A node can have at most one anchor"), g.source.endsWith(":") && r(g.offset + g.source.length - 1, "BAD_ALIAS", "Anchor ending in : is ambiguous", true), m = g, k === null && (k = g.offset), c = false, p = false, y = true;
        break;
      case "tag": {
        b && r(g, "MULTIPLE_TAGS", "A node can have at most one tag"), b = g, k === null && (k = g.offset), c = false, p = false, y = true;
        break;
      }
      case t:
        (m || b) && r(g, "BAD_PROP_ORDER", `Anchors and tags must be after the ${g.source} indicator`), w && r(g, "UNEXPECTED_TOKEN", `Unexpected ${g.source} in ${e ?? "collection"}`), w = g, c = t === "seq-item-ind" || t === "explicit-key-ind", p = false;
        break;
      case "comma":
        if (e) {
          N && r(g, "UNEXPECTED_TOKEN", `Unexpected , in ${e}`), N = g, c = false, p = false;
          break;
        }
      // else fallthrough
      default:
        r(g, "UNEXPECTED_TOKEN", `Unexpected ${g.type} token`), c = false, p = false;
    }
...
` + m.comment : l.comment = m.comment);
    ...
    t.schema.compat && ut(n.indent, h, i), t.atKey = false, gs(t, l.items, N) && i(S, "DUPLICATE_KEY", "Map keys must be unique");
    const w = ue(y ?? [], {
...
function un({ composeNode: s, composeEmptyNode: e }, t, n, i, r) {
  ...
  c.flow = true;
  const p = t.atRoot;
  p && (t.atRoot = false), t.atKey && (t.atKey = false);
...
` + I : g.comment = I, O.comment = O.comment.substring(I.length + 1);
    ...
    if (!o && !w && !O.found) {
      ...
      nt(N) && i(g.range, "BLOCK_IN_FLOW", st), t.atKey = false;
      const _ = ue(w ?? [], {
        flow: l,
        indicator: "map-value-ind",
        next: k,
...
function hn(s, e, t, n, i) {
  ...
  if (!a) {
    ...
    if (h && h.collection === l)
      e.schema.tags.push(Object.assign({}, h, { default: false })), a = h;
    else
      return h ? i(r, "BAD_COLLECTION_TYPE", `${h.tag} used for ${l} collection, but expects ${h.collection ?? "scalar"}`, true) : i(r, "TAG_RESOLVE_FAILED", `Unresolved tag: ${o}`, true), it(s, e, t, i, o);
  }
...
function kn(s, e, t, n, i) {
  ...
  return o && !o.collection ? (s.tags.push(Object.assign({}, o, { default: false, test: void 0 })), o) : (i(n, "TAG_RESOLVE_FAILED", `Unresolved tag: ${t}`, t !== "tag:yaml.org,2002:str"), s[R]);
}
function Nn({ atKey: s, directives: e, schema: t }, n, i, r) {
  const o = t.tags.find((l) => {
    var a;
    return (l.default === true || s && l.default === "key") && ((a = l.test) == null ? void 0 : a.test(n));
  }) || t[R];
  if (t.compat) {
...
var An = { composeNode: Ns, composeEmptyNode: Et };
function Ns(s, e, t, n) {
  ...
  switch (e.type) {
    ...
    default: {
      ...
      n(e, "UNEXPECTED_TOKEN", f), c = Et(s, e.offset, void 0, null, t, n), p = false;
    }
  }
  return l && c.anchor === "" && n(l, "BAD_ALIAS", "Anchor cannot be an empty string"), i && s.options.stringKeys && (!E(c) || typeof c.value != "string" || c.tag && c.tag !== "tag:yaml.org,2002:str") && n(a ?? e, "NON_STRING_KEY", "With stringKeys, all keys must be strings"), r && (c.spaceBefore = true), o && (e.type === "scalar" && e.source === "" ? c.comment = o : c.commentBefore = o), s.options.keepSourceTokens && p && (c.srcToken = e), c;
}
...
function In(s, e, { offset: t, start: n, value: i, end: r }, o) {
  ...
  p.found && (a.directives.docStart = true, i && (i.type === "block-map" || i.type === "block-seq") && !p.hasNewline && o(p.end, "MISSING_CHAR", "Block collection cannot start on same line with directives-end marker")), a.contents = i ? Ns(c, i, p, o) : Et(c, p.end, n, null, p, o);
  const f = a.contents.range[2], d = Ie(r, f, false, o);
...
` : `
`) + (o.substring(1) || " "), t = true, n = false;
        break;
      case "%":
        ((i = s[r + 1]) == null ? void 0 : i[0]) !== "#" && (r += 1), t = false;
        break;
      default:
        t || (n = true), t = false;
    }
...
var Pn = Object.freeze(Object.defineProperty({
  __proto__: null,
  BOM: ze,
  DOCUMENT: Ze,
  FLOW_END: xe,
...
var Pt = new Set("0123456789ABCDEFabcdef");
var jn = new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()");
var _e = new Set(",[]{}");
var Dn = new Set(` ,[]{}
\r	`);
var ot = (s) => !s || Dn.has(s);
...
var Tt = class {
   ...
   */
  constructor(e) {
    this.atNewLine = true, this.atScalar = false, this.indent = 0, this.offset = 0, this.onKeyLine = false, this.stack = [], this.source = "", this.type = "", this.lexer = new Ts(), this.onNewLine = e;
  }
  /**
  ...
  *blockMap(e) {
    ...
    if (this.indent >= e.indent) {
      ...
      switch (this.type) {
        case "anchor":
        case "tag":
          r || t.value ? (o.push(this.sourceToken), e.items.push({ start: o }), this.onKeyLine = true) : t.sep ? t.sep.push(this.sourceToken) : t.start.push(this.sourceToken);
          return;
        case "explicit-key-ind":
          !t.sep && !t.explicitKey ? (t.start.push(this.sourceToken), t.explicitKey = true) : r || t.value ? (o.push(this.sourceToken), e.items.push({ start: o, explicitKey: true })) : this.stack.push({
            type: "block-map",
            offset: this.offset,
            indent: this.indent,
        ...
        case "double-quoted-scalar": {
          ...
          r || t.value ? (e.items.push({ start: o, key: l, sep: [] }), this.onKeyLine = true) : t.sep ? this.stack.push(l) : (Object.assign(t, { key: l, sep: [] }), this.onKeyLine = true);
          return;
        }
        default: {
...
//# sourceMappingURL=index-DcHeSvkE-5XP6SISH.js.map
