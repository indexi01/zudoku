...
// node_modules/zudoku/lib/chunk-KNED5TY2-BUPjb3LQ.js
var o = __toESM(require_react(), 1);
var _ = {};
var ue;
function Me() {
  if (ue) return _;
  ue = 1, Object.defineProperty(_, "__esModule", { value: true }), _.parse = c, _.serialize = s;
  const e = /^[\u0021-\u003A\u003C\u003E-\u007E]+$/, t = /^[\u0021-\u003A\u003C-\u007E]*$/, n = /^([.]?[a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)([.][a-z0-9]([a-z0-9-]{0,61}[a-z0-9])?)*$/i, a = /^[\u0020-\u003A\u003D-\u007E]*$/, r = Object.prototype.toString, i = (() => {
    const d = function() {
    };
...
function tt() {
  ...
  let e = o.useContext(I), { basename: t, navigator: n } = o.useContext(T), { matches: a } = o.useContext(k), { pathname: r } = N(), i = JSON.stringify(Z(a)), c = o.useRef(false);
  return Re(() => {
    c.current = true;
  }), o.useCallback(
    (l, s = {}) => {
...
function rt(e) {
  ...
  return t && o.createElement(nt.Provider, { value: e }, t);
}
function ln() {
...
function at() {
  ...
  return console.error(
    ...
    e
  ), c = o.createElement(o.Fragment, null, o.createElement("p", null, "💿 Hey developer 👋"), o.createElement("p", null, "You can provide a way better UX than this when your app throws errors by providing your own ", o.createElement("code", { style: i }, "ErrorBoundary"), " or", " ", o.createElement("code", { style: i }, "errorElement"), " prop on your route.")), o.createElement(o.Fragment, null, o.createElement("h2", null, "Unexpected Application Error!"), o.createElement("h3", { style: { fontStyle: "italic" } }, t), n ? o.createElement("pre", { style: r }, n) : null, c);
}
var it = o.createElement(at, null);
var ot = class extends o.Component {
  constructor(e) {
    super(e), this.state = {
      location: e.location,
  ...
  render() {
    return this.state.error !== void 0 ? o.createElement(k.Provider, { value: this.props.routeContext }, o.createElement(
      ne.Provider,
      {
...
function lt({ routeContext: e, match: t, children: n }) {
  ...
  return a && a.static && a.staticContext && (t.route.errorElement || t.route.ErrorBoundary) && (a.staticContext._deepestRenderedBoundaryId = t.route.id), o.createElement(k.Provider, { value: e }, n);
}
  ...
  if (n)
    for (let l = 0; l < r.length; l++) {
      ...
      if ((s.route.HydrateFallback || s.route.hydrateFallbackElement) && (u = l), s.route.id) {
        ...
        if (s.route.lazy || d) {
          c = true, u >= 0 ? r = r.slice(0, u + 1) : r = [r[0]];
          break;
        }
      }
    }
  return r.reduceRight((l, s, h) => {
    let p, d = false, v = null, f = null;
    n && (p = i && s.route.id ? i[s.route.id] : void 0, v = s.route.errorElement || it, c && (u < 0 && h === 0 ? (Pe(
      "route-fallback",
      false,
      "No `HydrateFallback` element provided to render during initial hydration"
    ), d = true, f = null) : u === h && (d = true, f = s.route.hydrateFallbackElement || null)));
    let w = t.concat(r.slice(0, h + 1)), E = () => {
      let m;
      return p ? m = v : d ? m = f : s.route.Component ? m = o.createElement(s.route.Component, null) : s.route.element ? m = s.route.element : m = l, o.createElement(
        lt,
        {
          match: s,
          routeContext: {
    ...
    return n && (s.route.ErrorBoundary || s.route.errorElement || h === 0) ? o.createElement(
      ot,
      {
        location: n.location,
        ...
        error: p,
        children: E(),
        routeContext: { outlet: null, matches: w, isDataRoute: true }
      }
    ) : E();
  }, null);
}
...
function un({
  ...
  let [n, a] = o.useState(e.state), [r, i] = o.useState(), [c, u] = o.useState({
    ...
    (y, { deletedFetchers: R, flushSync: x, viewTransitionOpts: C }) => {
      ...
      if (t && x) {
        ...
        P.finished.finally(() => {
          t(() => {
            s(void 0), p(void 0), i(void 0), u({ isTransitioning: false });
          });
        }), t(() => p(P));
        return;
      }
  ...
  return o.createElement(o.Fragment, null, o.createElement(I.Provider, { value: g }, o.createElement(F.Provider, { value: n }, o.createElement(te.Provider, { value: f.current }, o.createElement(J.Provider, { value: c }, o.createElement(
    Se,
    {
      basename: m,
      location: n.location,
...
function Se({
  ...
  ), v == null ? null : o.createElement(T.Provider, { value: u }, o.createElement(K.Provider, { children: t, value: v }));
}
var V = "get";
var j = "application/x-www-form-urlencoded";
function q(e) {
...
function me(e, t, n, a, r, i) {
  let c = (l, s) => n[s] ? l.route.id !== n[s].route.id : true, u = (l, s) => {
    var h;
    return (
...
function It(e, t) {
  let n = o.useContext(le), [a, r] = o.useState(false), [i, c] = o.useState(false), { onFocus: u, onBlur: l, onMouseEnter: s, onMouseLeave: h, onTouchStart: p } = t, d = o.useRef(null);
  o.useEffect(() => {
    if (e === "render" && c(true), e === "viewport") {
      let w = (m) => {
        m.forEach((g) => {
          c(g.isIntersecting);
        });
...
function Ot({
  ...
  return a ? o.createElement(_t, { page: e, matches: a, ...t }) : null;
}
function Ft(e) {
...
function _t({
  ...
  let a = N(), { manifest: r, routeModules: i } = ke(), { basename: c } = Le(), { loaderData: u, matches: l } = Dt(), s = o.useMemo(
    ...
    if (e === a.pathname + a.search + a.hash)
      return [];
    let f = /* @__PURE__ */ new Set(), w = false;
    if (t.forEach((m) => {
      var y;
      let g = r.routes[m.route.id];
      !g || !g.hasLoader || (!s.some((R) => R.route.id === m.route.id) && m.route.id in u && ((y = i[m.route.id]) != null && y.shouldRevalidate) || g.hasClientLoader ? w = true : f.add(m.route.id));
    }), f.size === 0)
      return [];
    let E = Mt(e, c);
  ...
  return o.createElement(o.Fragment, null, p.map((f) => o.createElement("link", { key: f, rel: "prefetch", as: "fetch", href: f, ...n })), d.map((f) => o.createElement("link", { key: f, rel: "modulepreload", href: f, ...n })), v.map(({ key: f, link: w }) => (
    // these don't spread `linkProps` because they are full link descriptors
    // already with their own props
    o.createElement("link", { key: f, ...w })
  )));
}
function Ut(...e) {
  return (t) => {
...
var Ne = o.forwardRef(
  function({
    ...
    let { basename: f } = o.useContext(T), w = typeof s == "string" && Te.test(s), E, m = false;
    if (typeof s == "string" && w && (E = s, $e))
      try {
        ...
        D.origin === S.origin && se != null ? s = se + D.search + D.hash : m = true;
      } catch {
        L(
          false,
    ...
    return y && !w ? o.createElement(o.Fragment, null, P, o.createElement(Ot, { page: g })) : P;
  }
);
Ne.displayName = "Link";
var Bt = o.forwardRef(
  function({
    ...
    Kt(p) && u === true, m = f.encodeLocation ? f.encodeLocation(p).pathname : p.pathname, g = d.pathname, y = v && v.navigation && v.navigation.location ? v.navigation.location.pathname : null;
...
function dn(e) {
  ...
  let t = o.useRef(Q(e)), n = o.useRef(false), a = N(), r = o.useMemo(
    () => (
...
function hn({
  ...
  return o.createElement(o.Fragment, null, o.createElement(I.Provider, { value: r }, o.createElement(F.Provider, { value: u }, o.createElement(te.Provider, { value: i }, o.createElement(J.Provider, { value: { isTransitioning: false } }, o.createElement(
    Se,
    {
      basename: r.basename,
      location: u.location,
...
zudoku/lib/chunk-KNED5TY2-BUPjb3LQ.js:
  (**
   * react-router v7.5.0
   *
   ...
   *)
*/
//# sourceMappingURL=chunk-DCQBGROG.js.map
